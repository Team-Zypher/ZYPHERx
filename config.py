...
BG_IMAGE = getenv("BG_IMAGE", "https://raw.githubusercontent.com/Team-Zypher/ZYPHERx/main/etc/20211024_105134.png")
...
OWNER_ID = int(os.environ.get("OWNER_ID", '2003485925'))
